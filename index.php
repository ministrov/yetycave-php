    ...
    <div class="page-wrapper">
        ...
        <main class="container">
            <section class="promo">
                ...
                $array_string = implode($numbers);

                print($array_string);
                print(var_dump($array_string));

                function get_example($num) {
                    print($num);
                    print(number_format($num, 2, ' ', ' '));

                    print($GLOBALS['int'] + $GLOBALS['second_int']);
                }

                get_example(ceil($format_num));

                print(var_dump(get_format_number($format_num)));
                        ...
                        <div class="lot__info">
                            ...
                            <div class="lot__state">
                                <div class="lot__rate">
                                    ...
                                    <span class="lot__cost"><?= get_format_number($good["price"]) ?></span>
                                </div>
